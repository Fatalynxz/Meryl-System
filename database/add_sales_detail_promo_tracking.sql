...
JOIN public.payment pay ON pay.sales_id = st.sales_id
JOIN public.promo_product pp ON pp.product_id = sd.product_id
JOIN public.promotion promo ON promo.promo_id = pp.promo_id
