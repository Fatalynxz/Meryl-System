...
const users: UserRecord[] = [
  ...
  { username: 'sales', password: 'sales123', role: 'sales', name: 'Sales Staff' },
  { username: 'inventory', password: 'inv123', role: 'inventory', name: 'Inventory Staff' },
];
...
export function Login() {
  ...
  const [selectedRole, setSelectedRole] = useState<'admin' | 'sales' | 'inventory' | null>(null);
  ...
  const quickLogin = (role: 'admin' | 'sales' | 'inventory') => {
